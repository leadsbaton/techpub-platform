...
export async function seedDemoContent(_payload: Payload) {
  return {
    disabled: true,
    message: 'Demo seeding is disabled. Use targeted seed scripts for production-safe data updates.',
  }
}
...
//       type: 'whitepaper',
//       status: 'published',
//       excerpt: 'A practical upgrade guide for manufacturing and design teams standardizing layout workflows, handoff quality, and production speed.',
//       primaryCategory: categoryId('technology'),
...
//       tags: pickTags('analytics', 'cloud'),
//       externalUrl: 'https://example.com/downloads/factory-layout-designers-upgrade-guide',
//       content: richTextFromParagraphs([
//         'Layout modernization projects move faster when designers share a repeatable upgrade path for tooling, templates, and manufacturing review loops.',
//         'This guide is designed to mirror the high-intent downloadable asset pattern used across the white paper hub.',
//       ]),
//     },
//     {
...
//       type: 'whitepaper',
//       status: 'published',
//       excerpt: 'A facilities-focused white paper covering controls, systems communication, and implementation considerations in commercial buildings.',
//       primaryCategory: categoryId('finance'),
//       authors: [authorIds.oracle],
//       featuredImage: mediaId('dashboard-card'),
//       pinned: true,
...
//       externalUrl: 'https://example.com/downloads/smarter-hvac-application-guide',
//       content: richTextFromParagraphs([
//         'Controls projects succeed when operators, finance stakeholders, and implementation partners align on communication standards early.',
//         'This guide packages that planning work into a format suited for gated content journeys and category-led discovery.',
//       ]),
//     },
//     {
...
//       type: 'whitepaper',
//       status: 'published',
//       excerpt: 'A concise executive guide for marketing and operations teams planning around trade volatility, localization, and channel shifts.',
//       primaryCategory: categoryId('marketing'),
//       authors: [authorIds.editorial],
//       featuredImage: mediaId('dashboard-wide'),
//       readingTime: 7,
...
//       externalUrl: 'https://example.com/downloads/navigating-global-trade-insights',
//       content: richTextFromParagraphs([
//         'Trade conditions reshape campaign planning, buyer communication, and channel strategy long before they show up in quarter-end reporting.',
//         'This white paper gives leaders a faster way to align messaging and demand plans around uncertain market conditions.',
//       ]),
//     },
//     {
//       slug: 'predictive-maintenance-blueprint',
//       title: 'Predictive Maintenance Blueprint For Industrial Teams',
//       type: 'whitepaper',
//       status: 'published',
//       excerpt: 'A practical playbook for maintenance, plant, and operations leaders deploying predictive analytics across critical assets.',
//       primaryCategory: categoryId('technology'),
//       authors: [authorIds.autodesk],
//       featuredImage: mediaId('dashboard-card'),
//       readingTime: 9,
...
//       tags: pickTags('analytics', 'ai'),
//       externalUrl: 'https://example.com/downloads/predictive-maintenance-blueprint',
//       content: richTextFromParagraphs([
//         'Predictive maintenance programs work best when instrumentation, alerting, and operator workflows are aligned before scaling.',
//         'This white paper helps industrial teams map the operating model behind maintenance intelligence rather than only the tooling layer.',
//       ]),
//     },
//     {
//       slug: 'data-ops-for-global-finance-teams',
//       title: 'Data Ops For Global Finance Teams',
//       type: 'whitepaper',
//       status: 'published',
//       excerpt: 'An operating guide for finance leaders improving close cycles, reconciliations, and governed reporting across regions.',
//       primaryCategory: categoryId('finance'),
//       authors: [authorIds.oracle],
//       featuredImage: mediaId('dashboard-wide'),
//       readingTime: 8,
...
//       tags: pickTags('analytics', 'cloud'),
//       externalUrl: 'https://example.com/downloads/data-ops-for-global-finance-teams',
//       content: richTextFromParagraphs([
//         'Finance modernization needs more than dashboards. It needs data operations discipline, clear ownership, and repeatable controls.',
//         'This white paper outlines a practical operating model for finance teams balancing speed, governance, and regional complexity.',
//       ]),
//     },
//     {
//       slug: 'campaign-measurement-in-fragmented-channels',
//       title: 'Campaign Measurement In Fragmented Channels',
//       type: 'whitepaper',
//       status: 'published',
//       excerpt: 'A guide for marketing teams trying to unify campaign reporting, attribution assumptions, and executive storytelling.',
//       primaryCategory: categoryId('marketing'),
//       authors: [authorIds.editorial],
//       featuredImage: mediaId('dashboard-source'),
//       readingTime: 7,
//       publishedAt: '2026-01-08T08:00:00.000Z',
//       tags: pickTags('analytics', 'cloud'),
//       externalUrl: 'https://example.com/downloads/campaign-measurement-in-fragmented-channels',
//       content: richTextFromParagraphs([
//         'Fragmented channel mixes make marketing measurement harder when definitions drift and reporting cadences vary by team.',
//         'This resource gives operators a shared framework for narrative consistency, performance review, and cross-channel planning.',
//       ]),
//     },
//     {
//       slug: 'manufacturing-visibility-stack-guide',
//       title: 'Manufacturing Visibility Stack Guide',
//       type: 'whitepaper',
//       status: 'published',
//       excerpt: 'A buyer-focused guide to instrumentation, reporting, and workflow visibility for digital manufacturing teams.',
//       primaryCategory: categoryId('technology'),
//       authors: [authorIds.autodesk],
//       featuredImage: mediaId('dashboard-wide'),
//       readingTime: 10,
...
//       tags: pickTags('cloud', 'analytics'),
//       externalUrl: 'https://example.com/downloads/manufacturing-visibility-stack-guide',
//       content: richTextFromParagraphs([
//         'Visibility programs improve throughput when analytics, design, and operations teams share one language for workflow state and exceptions.',
//         'This white paper is aimed at teams comparing practical visibility investments across plant, design, and reporting layers.',
//       ]),
//     },
//     {
//       slug: 'finance-planning-controls-playbook',
//       title: 'Finance Planning Controls Playbook',
//       type: 'whitepaper',
//       status: 'published',
//       excerpt: 'A controls and communications playbook for finance planning teams standardizing scenario planning and approvals.',
//       primaryCategory: categoryId('finance'),
//       authors: [authorIds.oracle, authorIds.editorial],
//       featuredImage: mediaId('dashboard-card'),
//       readingTime: 8,
//       publishedAt: '2026-01-04T08:00:00.000Z',
//       tags: pickTags('ai', 'analytics'),
//       externalUrl: 'https://example.com/downloads/finance-planning-controls-playbook',
//       content: richTextFromParagraphs([
//         'Planning teams need clarity on controls, ownership, and scenario inputs before speed improvements can be trusted.',
//         'This white paper focuses on the planning operating model behind more reliable finance execution.',
//       ]),
//     },
//     {
//       slug: 'marketing-content-operations-guide',
//       title: 'Marketing Content Operations Guide',
//       type: 'whitepaper',
//       status: 'published',
//       excerpt: 'A workflow guide for content and demand teams trying to scale approvals, reuse, localization, and campaign consistency.',
//       primaryCategory: categoryId('marketing'),
//       authors: [authorIds.editorial],
//       featuredImage: mediaId('dashboard-card'),
//       readingTime: 7,
...
//       tags: pickTags('cloud', 'analytics'),
//       externalUrl: 'https://example.com/downloads/marketing-content-operations-guide',
//       content: richTextFromParagraphs([
//         'Content operations break down when reuse, approvals, and campaign planning are managed in disconnected workflows.',
//         'This white paper gives marketing operators a framework for cleaner execution at higher publishing volume.',
//       ]),
//     },
//     {
...
//     },
//     {
//       slug: 'bridging-ai-existing-systems-workflows',
//       title: 'Bridging the Gap: Integrating AI into Existing Systems and Workflows',
//       type: 'webinar',
//       status: 'published',
//       excerpt: 'A practical webinar for teams connecting new AI workflows with legacy systems, operational data, and internal process control.',
//       primaryCategory: categoryId('technology'),
//       authors: [authorIds.oracle],
//       featuredImage: mediaId('dashboard-wide'),
//       featured: true,
...
//       tags: pickTags('ai', 'analytics'),
//       videoUrl: 'https://example.com/webinars/bridging-ai-existing-systems',
//       externalUrl: 'https://example.com/register/bridging-ai-existing-systems',
//       webinarRegistration: {
//         enabled: true,
//         ctaLabel: 'Register now',
//       },
...
//         'This session helps enterprise teams make AI adoption practical inside the workflows they already run every day.',
//       ]),
//     },
//     {
//       slug: 'whats-ahead-in-data-architecture-2026',
//       title: "What's Ahead in Data Architecture for 2026",
//       type: 'webinar',
//       status: 'published',
//       excerpt: 'A forward-looking webinar on the architecture patterns, governance controls, and platform expectations shaping 2026.',
//       primaryCategory: categoryId('technology'),
//       authors: [authorIds.oracle],
//       featuredImage: mediaId('dashboard-card'),
//       readingTime: 4,
...
//       externalUrl: 'https://example.com/register/data-architecture-2026',
//       webinarRegistration: {
//         enabled: true,
//         ctaLabel: 'Register now',
//       },
...
//         'This webinar highlights the decisions teams should prioritize first when planning next-year data architecture investments.',
//       ]),
//     },
//     {
//       slug: 'explainability-trustworthy-ai-models',
//       title: 'Explainability and Interpretability: Building Trustworthy AI Models',
//       type: 'webinar',
//       status: 'published',
//       excerpt: 'A webinar for AI, data, and governance teams focused on explainability patterns that improve trust and adoption.',
//       primaryCategory: categoryId('technology'),
//       authors: [authorIds.editorial],
//       featuredImage: mediaId('dashboard-source'),
//       readingTime: 4,
...
//       tags: pickTags('ai', 'analytics'),
//       videoUrl: 'https://example.com/webinars/explainability-trustworthy-ai-models',
//       externalUrl: 'https://example.com/register/explainability-trustworthy-ai-models',
//       webinarRegistration: {
//         enabled: true,
//         ctaLabel: 'Register now',
//       },
...
//         'This webinar gives leaders a practical view of how trust-building mechanisms affect adoption and oversight.',
//       ]),
//     },
//     {
//       slug: 'finance-operations-automation-live',
//       title: 'Finance Operations Automation Live',
//       type: 'webinar',
//       status: 'published',
//       excerpt: 'A finance-focused webinar on workflow automation, reporting approvals, and exception handling across modern operations teams.',
//       primaryCategory: categoryId('finance'),
//       authors: [authorIds.oracle],
//       featuredImage: mediaId('dashboard-wide'),
//       readingTime: 4,
...
//       tags: pickTags('analytics', 'cloud'),
//       videoUrl: 'https://example.com/webinars/finance-operations-automation-live',
//       externalUrl: 'https://example.com/register/finance-operations-automation-live',
//       webinarRegistration: {
//         enabled: true,
//         ctaLabel: 'Register now',
//       },
...
//         'This session focuses on the operating model and data discipline required for automation efforts to stick.',
//       ]),
//     },
//     {
...
//       socialLinks: [
//         { platform: 'Facebook', url: 'https://www.facebook.com/profile.php?id=61566855997017&name=xhp_nt_' },
...
//           title: 'Quick Links',
//           links: [
//             { item: { label: 'Services', type: 'custom', url: 'https://leadsbaton.com/services/', newTab: false } },
//             { item: { label: 'Audience Data', type: 'custom', url: 'https://leadsbaton.com/audience-data/', newTab: false } },
//             { item: { label: 'News & Articles', type: 'custom', url: 'https://leadsbaton.com/news-articles/', newTab: false } },
//             { item: { label: 'Contact Us', type: 'custom', url: 'https://leadsbaton.com/contact-us/', newTab: false } },
//           ],
//         },
//       ],
//       footerContact: {
...
//           { address: 'Sreevari Complex, 1st Floor, Suite No. 7, Opposite to Mahaveer Cygnet, Kogilu Main Road, Yelahanka, Bengaluru, Karnataka- 560064' },
//           { address: '#17, New Aggarwal Colony, D.N. College Road, Hisar, Haryana-125001' },
//           { address: 'Leads Baton FZ-LLC, FDEK7867, Compass Building, Al Shohada Road, Al Hamra Industrial Zone-FZ Ras Al Khaimah, United Arab Emirates' },
//         ],
//         emails: [],
//       },
...
//         { label: "Don't Sell My Personal Information", href: 'https://leadsbaton.com/dont-sell-my-personal-information/' },
//       ],
//       newsletter: {
//         enabled: true,
