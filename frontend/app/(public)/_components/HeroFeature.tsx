...
function EchoCopy() {
  return (
    <div className="grid grid-cols-1 items-end gap-3 text-white sm:grid-cols-[1.28fr_0.76fr_0.76fr]">
      ...
      <div className="headline-font hidden pb-1 text-[0.83rem] font-bold leading-[1.02] text-white/92 sm:block sm:text-[0.94rem]">
        Explore,
        <br />
        Engage,
        <br />
...
export function HeroFeature({
  ...
  return (
    <section
      // Fixed decorative banner. Drop `herobg.png` into frontend/public to use it;
      // until then the purple fallback color shows. Only a very light overlay so
      // the banner shows close to full brightness once added.
      ...
      style={{
        backgroundImage:
          "linear-gradient(180deg, rgba(47,10,83,0.12) 0%, rgba(47,10,83,0.18) 100%), url('/herobg.png')",
      }}
    >
          ...
          <div className="grid grid-cols-1 gap-5 xl:grid-cols-[228px_minmax(0,1fr)] xl:gap-0">
            ...
            <div className="min-w-0 space-y-4 xl:space-y-5">
              <div className="relative overflow-hidden rounded-[18px] xl:ml-[-10px]">
                ...
                <div className="absolute inset-x-0 bottom-3 flex flex-col items-center justify-center gap-2 px-4 sm:flex-row sm:flex-wrap sm:bottom-4 md:bottom-5 md:gap-3 xl:justify-start xl:px-14">
                  <Link
                    href={webinarHref}
              ...
              <div className="-mr-4 min-w-0 overflow-x-auto pb-1 pr-4 xl:ml-[-4px] xl:mr-0 xl:overflow-visible xl:pr-0">
