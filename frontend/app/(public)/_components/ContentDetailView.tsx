      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1fr)_380px] lg:items-start">
        <div className="min-w-0 space-y-8">
          <div className="relative aspect-[16/9] overflow-hidden rounded-[32px]">
            <SafeImage src={getImageUrl(post.featuredImage)} alt={post.title} fill sizes="(max-width: 1024px) 100vw, 760px" className="object-cover" />
          </div>
      ...
      <section className="grid grid-cols-1 gap-8 lg:grid-cols-[280px_minmax(0,1fr)_360px] lg:items-start">
        <div className="rounded-[28px] bg-white p-5 shadow-[var(--shadow-soft)]">
          <div className="relative aspect-[4/5] overflow-hidden rounded-[18px] bg-[var(--surface-muted)]">
            <SafeImage src={getImageUrl(post.featuredImage)} alt={post.title} fill sizes="(max-width: 1024px) 100vw, 280px" className="object-cover" />
          </div>
          {primaryAction ? (
            <a
      ...
      <div className="space-y-5">
        ...
        <div className="overflow-hidden rounded-[32px] bg-white shadow-[var(--shadow-soft)]">
          <div className="relative aspect-[16/7] min-h-[260px]">
            <SafeImage src={getImageUrl(post.featuredImage)} alt={post.title} fill sizes="(max-width: 768px) 100vw, (max-width: 1280px) 90vw, 1200px" className="object-cover" />
